...
# Set wd
setwd("~/GitHub/ModelSelection_Simulation/Pre-Review/Results")
...
source("~/GitHub/ModelSelection_Simulation/Pre-Review/evaluation.R", echo=TRUE) # Source corrected evaluation script
setwd("~/GitHub/ModelSelection_Simulation/Pre-Review/Results/Fit") # Set correct wd
...
load("~/GitHub/ModelSelection_Simulation/Pre-Review/Results/FinalResCorrectModel.Rdata")
...
measures <- lapply(X = measures, FUN = factor, levels = c("Under", "Correct", "Over"), labels = c("-1", "0", "1")) %>% as.data.frame()
