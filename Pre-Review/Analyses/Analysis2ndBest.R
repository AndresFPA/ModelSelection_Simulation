...
# Source evaluation
source("C:/Users/User/Documents/GitHub/ModelSelection_Simulation/evaluation2ndBest.R")
...
# Main effects
count_results(data = Results_final2ndBest, by = "total", type = "relative")

K_res   <- count_results(data = Results_final2ndBest, by = c("nclus"), type = "relative")
N_res   <- count_results(data = Results_final2ndBest, by = c("N_g"), type = "relative")
G_res   <- count_results(data = Results_final2ndBest, by = c("ngroups"), type = "relative")
B_res   <- count_results(data = Results_final2ndBest, by = c("coeff"), type = "relative")
Bal_res <- count_results(data = Results_final2ndBest, by = c("balance"), type = "relative")
sd_res  <- count_results(data = Results_final2ndBest, by = c("sd"), type = "relative")

load("~/GitHub/ModelSelection_Simulation/Results/FinalResCorrectModel.Rdata") # Load results for the best model (not second best)

# Sum results for best and second best to obtain proportion of correct model among the best two models
count_results(data = Results_final2ndBest, by = "total", type = "relative") + count_results(data = Results_final, by = "total", type = "relative")
