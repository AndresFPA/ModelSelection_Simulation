...
setwd("~/GitHub/ModelSelection_Simulation/Post-Review")
...
nclus   <- c(1, 2, 4, 8)   # Number of clusters
ngroups <- 36              # Number of groups
...
genDat_analysis <- function(seed, RowDesign, k, NonInv){
  ...
  # Run model selection from 1 to 8 clusters
...
clusterEvalQ(cl, setwd("~/GitHub/ModelSelection_Simulation/Post-Review"))
